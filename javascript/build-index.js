...
const druidsHandbook = require(path.join(jsFolder, 'sources','the-complete-druids-handbook.js'));
const necromancersHandbook = require(path.join(jsFolder, 'sources','the-complete-necromancers-handbook.js'));
